...
extern FvsError_t FingerprintGetDirection_k(const FvsImage_t image, FvsFloatField_t field,
...
extern FvsError_t FingerprintGetFrequency3(const FvsImage_t image,
	const FvsFloatField_t direction,
	FvsFloatField_t frequency);
/******************************************************************************
